...
from models.layers import ResnetBlock
...
class DCDiscriminator(nn.Module):
    ...
    '''
    def __init__(self, in_dim=8, n_feat=1024, img_size=64):
...
class DiscriminatorResnet(nn.Module):
    ...
    '''
    def __init__(self, img_size, in_dim=8, nfilter=32, nfilter_max=512):
        super().__init__()
        ...
        self.conv_img = nn.Conv2d(in_dim, 1*nf, 3, padding=1)
